...
<template>
  <RadioGroupItem
    ...
    :class="
      cn(
        'relative border-input text-primary focus-visible:border-ring focus-visible:ring-ring/50 aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive dark:bg-input/75 aspect-square size-12 flex items-center justify-center shrink-0 rounded-full border shadow-xs transition-[color,box-shadow] outline-none focus-visible:ring-[3px] disabled:cursor-not-allowed disabled:opacity-50 cursor-pointer bg-white data-[state=checked]:border-lime-500 data-[state=checked]:bg-lime-200 dark:data-[state=checked]:bg-lime-900',
        props.class,
      )
    "
  >
